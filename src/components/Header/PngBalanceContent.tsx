	...
	return (
		<ContentWrapper gap="lg">
			<ModalUpper>
				...
				<CardSection gap="md">
					<RowBetween>
						<TYPE.white color="white">Your RIP Breakdown</TYPE.white>
				...
				<CardSection gap="sm">
					<AutoColumn gap="md">
						<RowBetween>
							<TYPE.white color="white">RIP price:</TYPE.white>
							<TYPE.white color="white">{pngPrice?.toFixed(5) ?? '-'} AVAX</TYPE.white>
						</RowBetween>
						<RowBetween>
							<TYPE.white color="white">RIP in circulation:</TYPE.white>

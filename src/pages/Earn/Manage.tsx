...
import { BIG_INT_ZERO, RIP } from '../../constants'
...
export default function Manage({
	...
	const [, avaxPngTokenPair] = usePair(CAVAX, RIP[chainId ? chainId : 43114])
	...
	if (avaxPool) {
		...
		var png
		if (tokenA && tokenA.equals(RIP[tokenA.chainId])) {
			token = tokenB
			png = tokenA
		} else {
			token = tokenA
	...
	return (
		<PageWrapper gap="lg" justify="center">
				...
				<BottomSection gap="lg" justify="center">
					...
					<StyledBottomCard dim={stakingInfo?.stakedAmount?.equalTo(JSBI.BigInt(0))}>
						...
						<AutoColumn gap="sm">
							<RowBetween>
								<div>
									<TYPE.black>Your unclaimed RIP</TYPE.black>
								</div>
           ...
           When you withdraw, the contract will automagically claim RIP on your behalf!
         </TYPE.main>

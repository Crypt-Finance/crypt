	...
	return (
		<PageWrapper gap="lg" justify="center">
			<TopSection gap="2px">
				...
				<TYPE.mediumHeader style={{ margin: '0.5rem 0' }} textAlign="center">Claim RIP from Airdrop</TYPE.mediumHeader>
				{!claimingAllowed ? (
					<Card padding="40px">
						...
						<span role="img" aria-label="party-hat">
							{' '}🎉
										...
										<ButtonError
											...
											onClick={onClaim}
										>
											{error ? error['data']['message'] : "Claim " + claimAmount?.toFixed(0, { groupSeparator: ',' }) + " RIP"}
										</ButtonError>
									)}

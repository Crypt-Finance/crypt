...
export const RIP: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, '0x9223349Ac8b3bE1e891800836bdA2A767307C0B9', 18, 'RIP', 'Crypt'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, '0x9223349Ac8b3bE1e891800836bdA2A767307C0B9', 18, 'RIP', 'Crypt')
}

...
import { RIP, DAI, UNI, SUSHI, ETH, USDT, WBTC, LINK, AAVE, YFI } from '../../constants'
...
export const STAKING_REWARDS_INFO: {
	...
	[ChainId.AVALANCHE]: [
		...
		{
			tokens: [WAVAX[ChainId.AVALANCHE], RIP[ChainId.AVALANCHE]],
...
export function useStakingInfo(pairToFilterBy?: Pair | null): StakingInfo[] {
	...
	const png = RIP[ChainId.AVALANCHE]
...
export function useTotalPngEarned(): TokenAmount | undefined {
	...
	const png = chainId ? RIP[chainId] : undefined
